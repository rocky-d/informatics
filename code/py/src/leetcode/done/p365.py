    ...
    def canMeasureWater(self, jug1Capacity: int, jug2Capacity: int, targetCapacity: int) -> bool:
        ...
        def dfs(jug1, jug2) -> bool:
            ...
            if targetCapacity in (jug1, jug2, jug1 + jug2):
                return True
            transfer1 = min(jug1, jug2Capacity - jug2)
            transfer2 = min(jug2, jug1Capacity - jug1)
            if dfs(jug1 = 0, jug2 = jug2):
                res = True
                ...
                res = True
            elif dfs(jug1 = jug1 - transfer1, jug2 = jug2 + transfer1):
                res = True
            elif dfs(jug1 = jug1 + transfer2, jug2 = jug2 - transfer2):
                res = True
            else:
                res = False
            return res
